...
*/
export function generate_raw_data(image_data_js, width, height) {
    try {
        var ret = wasm.generate_raw_data(addBorrowedObject(image_data_js), width, height);
...
export class ConversionResult {
    ...
    */
    get status() {
        var ret = wasm.__wbg_get_conversionresult_status(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set status(arg0) {
        wasm.__wbg_set_conversionresult_status(this.ptr, arg0);
    }
    /**
    */
    get message() {
        try {
            ...
            wasm.__wbg_get_conversionresult_message(retptr, this.ptr);
    ...
    */
    set message(arg0) {
        ...
        wasm.__wbg_set_conversionresult_message(this.ptr, ptr0, len0);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('image_assemblifier_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
